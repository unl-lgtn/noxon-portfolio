          ...
          <svg viewBox="0 0 200 200" className="w-full h-full">
            <defs>
              <linearGradient id="blob-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(var(--orange-primary))" />
                <stop offset="50%" stopColor="hsl(var(--orange-secondary))" />
          ...
          <svg viewBox="0 0 200 200" className="w-full h-full">
            <defs>
              <linearGradient id="blob-gradient-2" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="50%" stopColor="hsl(var(--orange-primary))" />
                <stop offset="100%" stopColor="hsl(var(--orange-secondary))" />
              </linearGradient>
            </defs>
            <path
        ...
        <div className="space-y-8 animate-fadeInUp">
          <div className="space-y-4">
            <h1 className="font-space-grotesk text-6xl md:text-8xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-foreground via-muted-foreground to-text-secondary bg-clip-text text-transparent">
                Noxon
              </span>
            </h1>
          ...
          <p className="font-inter text-xl md:text-2xl text-secondary leading-relaxed max-w-3xl mx-auto">
            Full-Stack Developer & Creative Technologist
          </p>
          
          <p className="font-inter text-lg text-muted leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
            <button 
              ...
              className="group relative px-8 py-4 bg-gradient-to-r from-orange-primary to-orange-secondary rounded-lg font-inter font-semibold text-primary-foreground transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-primary/25"
              data-cursor="View my projects"
            >
              View My Work
              <div className="absolute inset-0 bg-gradient-to-r from-orange-secondary to-orange-primary rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
            </button>
            
            <a 
              href="#contact"
              className="px-8 py-4 border border-border text-secondary rounded-lg font-inter font-semibold hover:border-orange-primary hover:text-orange-primary hover:bg-surface transition-all duration-300"
